...
class MyPasswordResetForm(PasswordResetForm):
    email=forms.EmailField(label=_("Email"),max_length=254,widget=forms.EmailInput(attrs={'autocompete':'email','class':'form-control'}))
    
class MySetPassordForm(SetPasswordForm):
